...
public class SymbolTable {
    ...
    public String writeLabel(String arg01) {
        return "(" + arg01 + ")";
    }

    public String writeGoto(String arg01) {
        return "@" + arg01 + "\n" + "0;JMP";
    }

    public String writeIf(String arg01) {
        int spRam = Integer.parseInt(this.getAddress("SP"));
        String ret = null;
    ...
    public String writeFunction(String arg01) {
        return "(" + arg01 + ")";
    }

    public String writeCall(String arg01, int arg02) {
        // int spRam = Integer.parseInt(this.getAddress("SP"));
        // int lclRam = Integer.parseInt(this.getAddress("LCL"));
        // int argRam = Integer.parseInt(this.getAddress("ARG"));
        // int thisRam = Integer.parseInt(this.getAddress("THIS"));
